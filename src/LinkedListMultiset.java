...
public class LinkedListMultiset<T> extends Multiset<T> {
	...
	/**
	 * Add a new value to the start of the list. (AddLast)
	 * 
	 * @param newValue
	...
	public void add(T item) {
		...
		// If head is empty, then list is empty and head and tail references
	 ...
	 * @param item
	 *            Value to search for.
	 * @return the found variable which present how many times the value is
	 *         found.
	 */
