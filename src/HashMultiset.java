...
/**
 * Hasp table/map implementation of a multiset. Implements Multiset abstract
 * class.
 * 
 * @param T
...
public class HashMultiset<T> extends Multiset<T> {
	/**
	 * Internal treemap used to implement multiset semantics. The mapped value
	 * stores the number of instances of each element.
	 */
	...
	public void print(PrintStream out) {
		...
		while (mit.hasNext()) {
			// need to suppress warning because of we are casting parameterised
			// types
